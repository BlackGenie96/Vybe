...
class PlaceListTutorial extends ModalRoute<void>{
  ...
  Widget _buildListOverlayContent(BuildContext context) => Column(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Text('Business Profile : Business listed from top to bottom based on its rating',textAlign:TextAlign.center,style:TextStyle(color:Colors.white,)),
        ),
        SizedBox(height: 15.0),
        RaisedButton(
          child: Text('Close'),
...
class PlacesProfileTutorial extends ModalRoute<void>{
  var state = "";
